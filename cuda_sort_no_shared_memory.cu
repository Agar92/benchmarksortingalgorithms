...
__global__ void fun1(int* ind01, int* ind23, int N,
                    P* particles__dev,
...
__global__ void fun2(int* count_minus1,
                     int* count0,
                     int* count1,
                     int* count2,
                     int* count3,
...
__global__ void fun3(P* particles__dev,
                     P* arr_minus1__dev, P* arr0__dev, P* arr1__dev, P* arr2__dev, P* arr3__dev,
                     int* init,
                     int* fin ,
                     int* count_minus1,
...
*/  
  ...
  fun1<<<(N+ThreadsPerBlock-1)/ThreadsPerBlock,ThreadsPerBlock>>>(ind01, ind23, N,
               particles__dev,
...
//cudaDeviceSynchronize();
  //
  fun3<<<(N+ThreadsPerBlock-1)/ThreadsPerBlock,ThreadsPerBlock>>>(
               particles__dev,
               arr_minus1__dev, arr0__dev, arr1__dev, arr2__dev, arr3__dev,
               init,
               fin,
  ...
  cudaMemcpyAsync(&particles__dev[0],&arr3__dev[0],PPOSITION3*sizep, cudaMemcpyDeviceToDevice);
  cudaMemcpyAsync(&particles__dev[PPOSITION3],&arr2__dev[0],PPOSITION2*sizep, cudaMemcpyDeviceToDevice);
  cudaMemcpyAsync(&particles__dev[PPOSITION23],&arr1__dev[0],PPOSITION1*sizep, cudaMemcpyDeviceToDevice);
  cudaMemcpyAsync(&particles__dev[PPOSITION23+PPOSITION1],&arr0__dev[0],PPOSITION0*sizep, cudaMemcpyDeviceToDevice);
  cudaMemcpyAsync(&particles__dev[PPOSITION23+PPOSITION1+PPOSITION0],&arr_minus1__dev[0], PPOSITION_MINUS1*sizep, cudaMemcpyDeviceToDevice);
