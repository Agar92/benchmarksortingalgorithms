                    ...
                    int* _POSITION_MINUS1_, int* _POSITION0_, int* _POSITION1_, int* _POSITION2_, int* _POSITION3_, int* _POSITION23_)
{
  ...
  __shared__ int init[Nbin];
  __shared__ int fin [Nbin];
  __shared__ int count01[Nbin];
  __shared__ int count23[Nbin];
  __shared__ int count_minus1[Nbin];
  __shared__ int count0[Nbin];
  __shared__ int count1[Nbin];
  __shared__ int count2[Nbin];
  __shared__ int count3[Nbin];
  __shared__ int mini[Nbin];
  __shared__ int ii0[Nbin];//not for ir=-1, but for ir=0, because ir=0 should stand before ir=-1 in sorted array particles 
  __shared__ int ii1[Nbin];
  __shared__ int ii3[Nbin];
  __shared__ int ii23[Nbin];
  __shared__ int POSITION3[Nbin];
  __shared__ int POSITION2[Nbin];
  __shared__ int POSITION1[Nbin];
  __shared__ int POSITION0[Nbin];
  __shared__ int POSITION_MINUS1[Nbin];
  __shared__ int POSITION23[Nbin];
  __shared__ int pointer_minus1[Nbin];
  __shared__ int pointer0[Nbin];
  __shared__ int pointer1[Nbin];
  __shared__ int pointer2[Nbin];
  __shared__ int pointer3[Nbin];
...
*/  
  ...
  fun<<<8,ThreadsPerBlock>>>(ind01, ind23, N,
               particles__dev,
